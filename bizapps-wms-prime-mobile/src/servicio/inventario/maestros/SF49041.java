...
import interfacedao.inventario.maestros.IF49041DAO;
...
public class SF49041 {
	...
	public F49041 buscarPorVehiculoYChofer(Double idChofer, String placaChuto) {
		List<F49041> lista = f49041DAO.findByIdVsstfnAndVsvehi(idChofer,
				placaChuto);
		if (!lista.isEmpty())
			return lista.get(0);
		return null;
