package modelo.inventario.historico;
...
import modelo.inventario.pk.F42119PK;


/**
 * The persistent class for the F42119 database table.
 * 
 */
@Entity
@Table(schema = "bizapps_wms_prime.dbo")
@NamedQuery(name="F42119.findAll", query="SELECT f FROM F42119 f")
public class F42119 implements Serializable {
	...
	public F42119PK getId() {
		return this.id;
	}

	public void setId(F42119PK id) {
		this.id = id;
	}
